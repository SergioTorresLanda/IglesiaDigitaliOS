...
public class ReactionsModalViewController: UIViewController, ReactionsModalViewProtocol {
    ...
    private func setUpView() {
        ...
        collectionView.register(UINib(nibName: "ReactionsInfoCVC",bundle: Bundle.local), forCellWithReuseIdentifier: "ReactionsInfoCVC")
        
        tableView.prefetchDataSource = self
        tableView.dataSource = self
        tableView.delegate = self
        tableView.separatorStyle = .none
        tableView.register(UINib(nibName: "ReactionsMoreInfoTVC", bundle: Bundle.local), forCellReuseIdentifier: "ReactionsMoreInfoTVC")
    }
