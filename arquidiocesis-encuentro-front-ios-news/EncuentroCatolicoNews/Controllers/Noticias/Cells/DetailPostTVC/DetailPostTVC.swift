...
public class DetailPostTVC: UITableViewCell {
    ...
    @IBOutlet public weak var reactionsStackView: UIStackView!
    ...
    private func setUpView() {
        ...
        containerMedia.clipsToBounds = true
        containerMedia.layer.cornerRadius = 15
        if #available(iOS 11.0, *) {
            containerMedia.layer.maskedCorners = [.layerMaxXMaxYCorner, .layerMinXMaxYCorner]
        } else { debugPrint("---- Lower version ----") }
