...
protocol FYV_VIPER_PresenterToViewProtocol: class {
...
class YoungView_Controller: UIViewController {
    ...
    func setUpView(reload: Bool){
        ...
        self._presenter?.getData(strTypeCatalog: strCodeCatalog)
...
//        imageFooter.contentMode = .scaleAspectFit
        ...
        costmSgmtCotroller = CustomSegmentController(frame: CGRect(x: 0, y: 0, width: self.view.frame.width, height: 0), sgmTitles: arTitles ?? [])
...
//            imageFooter.topAnchor.constraint(equalTo: costmSgmtCotroller.topAnchor, constant: -5),
...
//            imageFooter.leftAnchor.constraint(equalTo: self.view.leftAnchor, constant: (self.view.bounds.width/20)*11.2),
            ...
            costmSgmtCotroller.topAnchor.constraint(equalTo: searchField.bottomAnchor, constant: 66),
            ...
            collectionViewCatalg.heightAnchor.constraint(equalToConstant: 60),
            collectionViewCatalg.topAnchor.constraint(equalTo: safeArea.topAnchor, constant: 60),
...
extension YoungView_Controller: UITableViewDelegate, UITableViewDataSource {
