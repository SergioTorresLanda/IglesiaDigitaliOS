...
struct DoCallChurches: ResponseDispatcher {
    ...
    var data: RequestType {
        return RequestType(path: "/locations?priestId=" + id , method: .get, params: nil, url:Endpoints.urlGlobalApp)
          }
...
struct DoSearchBar: ResponseDispatcher {
    ...
    var data: RequestType {
        return RequestType(path: "/dev/v3/locations?name=" + name , method: .get, params: nil, url:Endpoints.urlSeacrh)
          }
