...
protocol FAV_VIPER_PresenterToInteractorProtocol: class {
    var _presenter: FAV_VIPER_InteractorToPresenterProtocol? {set get}
    func getData()
}

class FAV_ProfileInteractor: FAV_VIPER_PresenterToInteractorProtocol {
    var _presenter: FAV_VIPER_InteractorToPresenterProtocol?
    ...
    public func getFormationsComponets() -> Void {
        ...
        component.queryItems = [
            URLQueryItem(name: "type", value: "ADULTS")
        ]
