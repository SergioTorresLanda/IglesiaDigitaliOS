...
//        RealmManager.clearDataBase()
    ...
    private func showNextView() {
        if !vcWasShowed {
            ...
            let baseTabBar = SocialNetworkController(nibName: "SocialNetworkController", bundle: Bundle.local)
    ...
    private func fetchGroups() {
        ...
        let params = GroupsAll(FIIDEMPLEADO: SocialNetworkConstant.shared.userId)
