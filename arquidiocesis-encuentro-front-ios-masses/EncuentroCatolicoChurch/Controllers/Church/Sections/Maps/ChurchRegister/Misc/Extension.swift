...
extension UIColor {
    ...
    @nonobjc class var eMainGold: UIColor {
        return UIColor(named: "eMainGold",in: Bundle(for: ChurchRegisterViewController.self), compatibleWith: nil) ?? .yellow
    }
    
    @available(iOS 11.0, *)
    @nonobjc class var eMainBlue: UIColor {
      return UIColor(named: "eMainBlue",in: Bundle(for: ChurchRegisterViewController.self), compatibleWith: nil) ?? .blue
    }
    
    @available(iOS 11.0, *)
    @nonobjc class var eLightBlack: UIColor {
      return UIColor(named: "eLightBlack",in: Bundle(for: ChurchRegisterViewController.self), compatibleWith: nil) ?? .gray
    }
    
    @available(iOS 11.0, *)
    @nonobjc class var eDarkGold: UIColor {
      return UIColor(named: "eDarkGold",in: Bundle(for: ChurchRegisterViewController.self), compatibleWith: nil) ?? .brown
    }
    
    @available(iOS 11.0, *)
    @nonobjc class var eBlack: UIColor {
      return UIColor(named: "eBlack",in: Bundle(for: ChurchRegisterViewController.self), compatibleWith: nil) ?? .black
    }
    
    @available(iOS 11.0, *)
    @nonobjc class var eLightGray: UIColor {
      return UIColor(named: "eLightGray",in: Bundle(for: ChurchRegisterViewController.self), compatibleWith: nil) ?? .black
    }
    
    @available(iOS 11.0, *)
    @nonobjc class var eLightBlue: UIColor {
      return UIColor(named: "eLightBlue",in: Bundle(for: ChurchRegisterViewController.self), compatibleWith: nil) ?? .blue
    }
    
    @available(iOS 11.0, *)
    @nonobjc class var eGreenishBlue: UIColor {
      return UIColor(named: "eGreenishBlue",in: Bundle(for: ChurchRegisterViewController.self), compatibleWith: nil) ?? .green
    }
...
public extension Bundle {
    static let local: Bundle = Bundle(for: ChurchRegisterViewController.self)
}
