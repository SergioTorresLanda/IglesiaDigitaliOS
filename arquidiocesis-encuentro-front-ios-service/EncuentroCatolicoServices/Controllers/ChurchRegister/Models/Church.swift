...
struct Church: Codable {
    ...
    static func getChurch(id: UInt, completion: @escaping (Church?) -> Void) {
    ...
    static func getFavouriteChurches(completion: @escaping (Array<Church>) -> Void) {
        DummyData.shared.getChurchesData {
            churches in
    ...
    static func getNearByChurches(completion: @escaping (Array<Church>) -> Void) {
        DummyData.shared.getChurchesData {
            churches in
...
extension Church {
    static let chuch_dummy_1 = Church(id: 0,
                                      imageUrl: "https://lh3.googleusercontent.com/p/AF1QipMXdP6iIWq6Ge5ZjfRma72MiOPROG3jhsEW7q_u=w600-k",
    ...
    static let chuch_dummy_2 = Church(id: 1,
                                      imageUrl: "https://desdelafe.mx/wp-content/uploads/2019/06/Iglesia-Esperanza-de-Mar%C3%ADa-en-la-Resurrecci%C3%B3n-del-Se%C3%B1or.jpg",
    ...
    static let chuch_dummy_3 = Church(id: 2,
                                      imageUrl: "https://live.staticflickr.com/2641/4207883302_a5e7ed3d5c_b.jpg",
    ...
    static let chuch_dummy_4 = Church(id: 3,
                                      imageUrl: "https://4.bp.blogspot.com/-uapR0jN3e_c/Thvo5cS4F7I/AAAAAAAAAW4/kDzpPHyU3QI/s1600/Parroquia+.JPG",
    ...
    static let chuch_dummy_5 = Church(id: 4,
                                      imageUrl: "https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Fsevilla.abc.es%2Fmedia%2Fsevilla%2F2016%2F06%2F14%2Fs%2Fsanta-cruz-robo-kARG--620x349%40abc.jpg&f=1&nofb=1",
    ...
    static let chuch_dummy_6 = Church(id: 5,
                                      imageUrl: "https://scontent.fmex10-2.fna.fbcdn.net/v/t1.0-9/57457076_2393991440650682_885008917925462016_o.jpg?_nc_cat=100&_nc_sid=6e5ad9&_nc_ohc=SUYj5HcB1LsAX8zH7NJ&_nc_ht=scontent.fmex10-2.fna&oh=31a1c31fb18e1be066ebb7c418b5deae&oe=5F9F1C6A",
    ...
    static let chuch_dummy_7 = Church(id: 6,
                                      imageUrl: "https://live.staticflickr.com/3233/2934121177_4840bd5965_b.jpg",
    ...
    static let chuch_dummy_8 = Church(id: 7,
                                      imageUrl: "https://sites.google.com/a/defe.mx/www/_/rsrc/1397881211083/mexico-df/religion/parroquia-iglesia-santa-teresita/Parroquia%20Iglesia%20Santa%20Teresita%20Lomas.JPG?height=400&width=344",
    ...
    static let chuch_dummy_9 = Church(id: 8,
                                      imageUrl: "https://lh3.googleusercontent.com/p/AF1QipNDtoTr680xj7iDWY_cwpNRlznf_g8giwsG2aAW=w600-k",
    ...
    static let chuch_dummy_10 = Church(id: 9,
                                       imageUrl: "https://live.staticflickr.com/3168/2752606900_c3d3da2042_b.jpg",
    ...
    static let chuch_dummy_11 = Church(id: 10,
                                       imageUrl: "https://lh3.googleusercontent.com/moP1QOjVpGVEg3bFlprIYF0-XSerPG7yGhRF_oltZGzDxtvCG4cAMmSmwIXLYhbEGtWAcL-p=w1080-h608-p-no-v0",
