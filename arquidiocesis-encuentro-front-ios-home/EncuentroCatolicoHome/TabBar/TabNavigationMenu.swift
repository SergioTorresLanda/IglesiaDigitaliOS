...
public class TabNavigationMenu: UIImageView {
    ...
    private func createTabItem(item: TabItem) -> UIView {
        ...
        NSLayoutConstraint.activate([
            ...
            itemTitleLabel.centerYAnchor.constraint(equalTo: tabBarItem.centerYAnchor, constant: 15), //20
        ])
        ...
        NSLayoutConstraint.activate([
            ...
            itemIconView.centerYAnchor.constraint(equalTo: tabBarItem.centerYAnchor, constant: -15), //-10
        ])
