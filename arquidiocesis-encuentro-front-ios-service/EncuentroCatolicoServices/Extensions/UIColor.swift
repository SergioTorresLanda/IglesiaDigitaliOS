...
extension UIColor {
    ...
    @nonobjc class var eMainGold: UIColor {
      return UIColor(named: "eMainGold") ?? .yellow
    }
    
    @nonobjc class var eMainBlue: UIColor {
      return UIColor(named: "eMainBlue") ?? .blue
    }
    
    @nonobjc class var eLightBlack: UIColor {
      return UIColor(named: "eLightBlack") ?? .gray
    }
    
    @nonobjc class var eDarkGold: UIColor {
      return UIColor(named: "eDarkGold") ?? .brown
    }
    
    @nonobjc class var eBlack: UIColor {
      return UIColor(named: "eBlack") ?? .black
    }
    
    @nonobjc class var eLightGray: UIColor {
      return UIColor(named: "eLightGray") ?? .black
    }
    
    @nonobjc class var eLightBlue: UIColor {
      return UIColor(named: "eLightBlue") ?? .blue
    }
    
    @nonobjc class var eGreenishBlue: UIColor {
      return UIColor(named: "eGreenishBlue") ?? .green
    }
    
    @nonobjc class var eOrange: UIColor {
      return UIColor(named: "eOrange") ?? .orange
    }
